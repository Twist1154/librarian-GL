							...
							<div class="issue-wrapper">
								<form action="" class="form-control" method="post" name="idn">
										...
										<tr>
											<td class="">
												<select name="idn" id="" class="form-control">
													 <?php 
                                                        $res= mysqli_query($link, "select regno from t_registration");
                                    ...
                                    if (isset($_POST["submit1"])) {
                                       $res5 = mysqli_query($link, "select * from t_registration where regno='$_POST[idn]' ");
                                    ...
                                    if (isset($_POST["submit2"])) {
                                      ...
                                      $res= mysqli_query($link, "select * from add_book where books_name='$_POST[booksname]' ");
                                       ...
                                       if ($qty==0) {
                                          ...
                                          mysqli_query($link, "insert into t_issuebook values('','$_SESSION[utype]','$_SESSION[regno]','$_POST[name]','$_POST[teaches]','$_POST[phone]','$_POST[email]','$_POST[booksname]','$_POST[booksissuedate]','$_POST[booksreturndate]','$_SESSION[tusername]') ");
