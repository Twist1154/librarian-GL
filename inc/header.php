...
$not = 0;
$result = mysqli_query($link, "SELECT * FROM request_books WHERE read1='no'");
...
<div class="main-content">
    <div class="wrapper">
        <div class="left-sidebar">
            <div class="p-title">
                <h3><a href=""><i class="fas fa-book"></i><span>Growth Learning!</span></a></h3>
            </div>
            <div class="gap-40"></div>
            <div class="profile">
                <div class="profile-pic">
                    <?php
                    $sql ="select * from lib_registration where username='".$_SESSION['username']."'";
